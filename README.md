...
- Each purchase generates a line in a file called `transactionlog.txt`.
...
### Secret Menu Option (Sales Log)

If you select 4 in the main menu you will be creating a `saleslog` + currentDateAndTime`.txt` file with the sales report!
